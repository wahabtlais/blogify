...
<section class="dashboard">
    <?php if (isset($_SESSION['add-post-success'])) : // show if add post was succcessfull
    ?>
    ...
    <?php elseif (isset($_SESSION['edit-post-success'])) : // show if edit post was succcessfull
    ?>
    <div class="alert-message success container">
        <p>
    ...
    <?php elseif (isset($_SESSION['edit-post'])) : // show if edit post was NOT succcessfull
    ?>
    ...
    <?php elseif (isset($_SESSION['delete-post-success'])) : // show if delete post was succcessfull
    ?>
    <div class="alert-message success container">
        <p>
