...
if (isset($_GET['id'])) {
    ...
    if (mysqli_num_rows($thumbnails_result) > 0) {
        while ($thumbnail = mysqli_fetch_assoc($thumbnails_result)) {
            ...
            $delete_user_thumbnails = "DELETE FROM posts WHERE auther_id=$id AND thumbnail=$thumbnail";
            $delete_user_thumbnails_result = mysqli_query($connection, $delete_user_thumbnails);
