...
<section class="dashboard">
    <?php if (isset($_SESSION['add-category-success'])) : // show if add category was succcessfull
    ?>
    ...
    <?php elseif (isset($_SESSION['add-category'])) : // show if add category was NOT succcessfull
    ?>
    ...
    <?php elseif (isset($_SESSION['edit-category'])) : // show if edit category was NOT succcessfull
    ?>
    <div class="alert-message error container">
        <p>
    ...
    <?php elseif (isset($_SESSION['edit-category-success'])) : // show if edit category was succcessfull
    ?>
    <div class="alert-message success container">
        <p>
    ...
    <?php elseif (isset($_SESSION['delete-category-success'])) : // show if edit category was succcessfull
    ?>
    <div class="alert-message success container">
        <p>
