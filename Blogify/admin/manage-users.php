...
// fetch users from database but not cuurent user
...
<section class="dashboard">
    <?php if (isset($_SESSION['add-user-success'])) : // show if add user was succcessfull
    ?>
    ...
    <?php elseif (isset($_SESSION['edit-user-success'])) : // show if edit user was successfull
    ?>
    <div class="alert-message success container">
        <p>
    ...
    <?php elseif (isset($_SESSION['edit-user'])) : // show if edit user was NOT successfull
    ?>
    ...
    <?php elseif (isset($_SESSION['delete-user'])) : // show if delete user was NOT successfull
    ?>
    <div class="alert-message error container">
        <p>
    ...
    <?php elseif (isset($_SESSION['delete-user-success'])) : // show if delete user was successfull
    ?>
    <div class="alert-message success container">
        <p>
